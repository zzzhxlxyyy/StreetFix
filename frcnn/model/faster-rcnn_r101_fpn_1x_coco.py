...
data_root = '/notebooks/mmdetection/dataset/'
...
launcher = 'none'
load_from = 'work_dirs/faster-rcnn_r101_fpn_1x_coco/best_coco_bbox_mAP_epoch_20.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ann_file='/notebooks/mmdetection/dataset/test/_annotations.coco.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
